// 256 color definition taken from https://jonasjacek.github.io/colors/

import 'package:flutter/material.dart';

Color? getExtendedColor(int id) {
  // find ID
  final o = EXTENDED_COLORS.where((element) => element["colorId"] == id).toList();
